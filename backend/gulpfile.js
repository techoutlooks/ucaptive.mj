...
gulp.task('build', () => {
  ...
  return gulp.src(['./ucaptive/static/js/app.js',], { read: false })
...
function start_django_dev_server(done) {
  livereload.listen();
...
gulp.task('start_django_dev_server', ['build'], start_django_dev_server)


// Starts our development workflow
gulp.task('default', ['start_django_dev_server', 'build', 'watch'], function (done) {
  livereload.listen();
  done();
});
