/*
    ...
    npm install browserify babelify gulp gulp-if gulp-uglify gulp-streamify vinyl-source-stream gulp-notify \
            gulp-concat gulp-cssmin gulp-rename gulp-less glob path gulp-livereload gulp-mocha gulp-istanbul \
            isparta gulp-istanbul-enforcer gulp-modernizr  --save-dev
*/
...
var options = {
  src: './staticfiles/js/app.js',
  dest: './staticfiles/js/',

  modernizr: {
    src: './staticfiles/js/index.js',
    dest: './staticfiles/libs/',
  },

  css: {
    src: './staticfiles/less/index.less',
    watch: './staticfiles/less/**/*.less',
    dest: './staticfiles/css/'
  },
  development: false
}
...
gulp.task('test', function () {
  ...
  return gulp
    ...
    .on('finish', function () {
      gulp
        .src('./staticfiles/js/test/**/test_*.js', {read: false})
        .pipe(mocha({
          require: [
